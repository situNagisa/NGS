...
concept arithmetic_channel_equivalence = 
	arithmetic_channel<Left> && arithmetic_channel<Right>
	&& (NGS_LIB_MODULE_NAME::bit_count<Left>() == NGS_LIB_MODULE_NAME::bit_count<Right>())
	&& (NGS_LIB_MODULE_NAME::bit_count<Right>() == NGS_LIB_MODULE_NAME::bit_count<Left>())
;
