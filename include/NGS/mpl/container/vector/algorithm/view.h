...
NGS_mfunction(view, CVector _Rng, ccpt::UInt _Count = ccpt::uint_<_Rng::size>,ccpt::UInt _Offset = ccpt::uint_<0>, class = std::make_index_sequence<_Count::value>);
NGS_mfunction(view, CVector _Rng,ccpt::UInt _Offset, size_t... _Index) < _Rng, ccpt::uint_<0>, _Offset, std::index_sequence<_Index...> > {
	using result_type = replace_template_parameters_t<_Rng>;
};
NGS_mfunction(view, CVector _Rng, ccpt::UInt _Count,ccpt::UInt _Offset, size_t... _Index) < _Rng, _Count,_Offset, std::index_sequence<_Index...> > {
