...
NGS_mfunction(push_back, CVector _Sequence, class... _NewElements);

NGS_mfunction(push_back, template<class...>class _Sequence, class... _Element, class... _NewElements) < _Sequence<_Element...>, _NewElements... > {
