...
struct ScalarPlusFunctor : ScalarBinaryFunctor<_ElementType1, _ElementType2> {
private:
	using base_type = typename ScalarPlusFunctor::self_type;
public:
...
NGS_CCPT_VERIFY(CScalarBinaryFunctor, ScalarPlusFunctor<int, float>);
