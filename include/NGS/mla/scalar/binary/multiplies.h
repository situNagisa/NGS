...
struct ScalarMultipliesFunctor : ScalarBinaryFunctor<_ElementType1, _ElementType2> {
private:
	using base_type = typename ScalarMultipliesFunctor::self_type;
public:
...
NGS_CCPT_VERIFY(CScalarBinaryFunctor, ScalarMultipliesFunctor<int, float>);
