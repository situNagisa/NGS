...
#if !defined(NGS_LIB_GLOBAL_BEGIN) || !defined(NGS_LIB_GLOBAL_END)
#	define NGS_LIB_GLOBAL_BEGIN NGS_BEGIN
#	define NGS_LIB_GLOBAL_END NGS_END
#elif defined(NGS_LIB_GLOBAL_BEGIN) && defined(NGS_LIB_GLOBAL_END)
...
#		define NGS_LIB_BEGIN NGS_LIB_GLOBAL_BEGIN inline namespace NGS_LIB_NAME {
#		define NGS_LIB_END } NGS_LIB_GLOBAL_END
#		define NGS_LIB_FULL_QUALIFIER_NAME NGS_ NGS_LIB_NAME
#	else
