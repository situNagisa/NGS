...
public:
	...
	underlying_type page_size : 1 = static_cast<underlying_type>(enums::page_size::_4kb);
...
public:
	...
	underlying_type accessed : 1;
	underlying_type dirty : 1;
	underlying_type page_size : 1 = static_cast<underlying_type>(enums::page_size::_4mb);
...
using page_directory_entry = ::std::conditional_t<Size == enums::page_size::_4kb, page_directory_entry_4kb, page_directory_entry_4mb>;
