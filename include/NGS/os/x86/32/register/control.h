...
public:
	...
	using register_category_type = registers::cr0;
...
struct control1_register : trivial_register< registers::cr0>{};
...
public:
	using underlying_type = register_underlying_t;
	using register_category_type = registers::cr2;
...
public:
	using underlying_type = register_underlying_t;
	using register_category_type = registers::cr3;
...
public:
	using underlying_type = register_underlying_t;
	using register_category_type = registers::cr4;
