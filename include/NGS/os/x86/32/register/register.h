...
template<registers::register_tag Tag>
...
template<cpt::derived_from_specialization<bit16::trivial_register> Register, registers::register_tag Tag = registers::register_category_t<Register>>
