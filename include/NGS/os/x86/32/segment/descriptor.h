...
public:
	...
	constexpr segment_descriptor(
		...
		: _limit_low(static_cast<underlying_type>(bits::algorithm::extract(limit,0,16)))
		, _base_low(static_cast<underlying_type>(bits::algorithm::extract(base,0,16)))
		, _base_middle(static_cast<underlying_type>(bits::algorithm::extract(base,16,8)))
		...
		, _limit_high(static_cast<underlying_type>(bits::algorithm::extract(limit,16,4)))
		...
		, _base_high(static_cast<underlying_type>(bits::algorithm::extract(base,24,8)))
	{}
	...
	constexpr pointer_underlying_t base() const noexcept
	{
	...
	auto span() const noexcept { return ::std::span(reinterpret_cast<byte*>(base()), size()); }
};
