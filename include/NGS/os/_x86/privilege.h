...
constexpr auto high(privilege left, privilege right) { return ::std::min(left, right); }
constexpr auto low(privilege left, privilege right) { return ::std::max(left, right); }
...
constexpr auto high(page_privilege left, page_privilege right) { return ::std::min(left, right); }
constexpr auto low(page_privilege left, page_privilege right) { return ::std::max(left, right); }
