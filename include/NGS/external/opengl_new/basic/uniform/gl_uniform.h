...
namespace _detail
{
	template<NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental T, ::std::size_t Dimension, bool Array = false>
...
//
	...
	NGS_EXTERNAL_OPENGL_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::floating_point, f);
	NGS_EXTERNAL_OPENGL_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::floating_point, f, v);
	NGS_EXTERNAL_OPENGL_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::integral, i);
	NGS_EXTERNAL_OPENGL_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::integral, i, v);
	NGS_EXTERNAL_OPENGL_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::unsigned_integral, ui);
	NGS_EXTERNAL_OPENGL_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::unsigned_integral, ui, v);
...
#define glUniformMatrix4x4fv glUniformMatrix4fv
	...
	template<NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental T, ::std::size_t Major, ::std::size_t Minor>
...
//
	...
	NGS_EXTERNAL_OPENGL_MATRIX_UNIFORM_MAP_SEQUENCE(NGS_EXTERNAL_OPENGL_BASIC_ENUM_NS::buffer_uniform_fundamental::floating_point, f);
...
inline constexpr struct
{
	void _set(::std::ptrdiff_t location, auto first, auto... value)const
	{
		_detail::gl_uniform_map<
			NGS_EXTERNAL_OPENGL_BASIC_REFLECT_NS::buffer_uniform_reflecter::reflect<decltype(first)>::value,
			sizeof...(value) + 1,
			false>::value(static_cast<GLint>(location), first, value...);
	}

	void operator()(::std::ptrdiff_t location, fundamental auto value) const { this->_set(location, value); }
		...
		requires uniform<::std::ranges::range_value_t<decltype(data)>>
	{
		...
		if constexpr (fundamental<range_value_type>)
		{
			_detail::gl_uniform_map<NGS_EXTERNAL_OPENGL_BASIC_REFLECT_NS::buffer_uniform_reflecter::reflect<range_value_type>::value,1,true>::value(static_cast<GLint>(location), static_cast<GLsizei>(::std::ranges::size(data)), ::std::ranges::data(data));
		}
		if constexpr (vector<range_value_type>)
		{
			_detail::gl_uniform_map<
				NGS_EXTERNAL_OPENGL_BASIC_REFLECT_NS::buffer_uniform_reflecter::reflect<typename vector_trait<range_value_type>::value_type>::value,
		...
		requires matrix<::std::ranges::range_value_t<decltype(data)>>
	{
		_detail::gl_matrix_uniform_map<
			NGS_EXTERNAL_OPENGL_BASIC_REFLECT_NS::buffer_uniform_reflecter::reflect<typename matrix_trait<::std::ranges::range_value_t<decltype(data)>>::value_type>::value,
