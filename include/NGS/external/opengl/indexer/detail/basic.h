...
template<class Derived, enums::element_draw_mode DrawMode, ::std::size_t LeastVertexCount,::std::invocable<::std::size_t> auto Map>
...
public:
	...
	constexpr static enums::element_draw_mode topology() { return DrawMode; }
