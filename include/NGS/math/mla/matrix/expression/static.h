...
struct NGS_API StaticMatrix : MatrixExpression<StaticMatrix<_Row, _Col, _ElementType, _Element...>> {
private:
	using base_type = StaticMatrix::self_type;
protected:
	using self_type = StaticMatrix;
public:
