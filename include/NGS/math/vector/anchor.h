...
namespace detail {
	...
	template<template<class...>class _API, depth_t _Depth, class... _V>
		requires ((_Depth < depth_v<_V>) && ...)
	struct anchor { using type = _API<value_at_t<_V, _Depth>...>; };

	template<template<class...>class _API, depth_t _Depth, class... _V>
	using anchor_t = typename anchor<_API, _Depth, _V...>::type;
...
template<class _V, NGS_NS::NGS_LIB_NAME::index_t _Index>								\
concept api##_at = NGS_NS::NGS_LIB_NAME::api<NGS_NS::NGS_LIB_NAME::value_at_t<_V, _Index>>\
//

#define NGS_MATH_VECTOR_RECURSE_ANCHOR_CONCEPT_BINARY(api)				\
template<class _V,class _With, NGS_NS::NGS_LIB_NAME::index_t _Index>	\
concept api##_at = NGS_NS::NGS_LIB_NAME::api<							\
	NGS_NS::NGS_LIB_NAME::value_at_t<_V, _Index>,						\
	NGS_NS::NGS_LIB_NAME::value_at_t<_With, _Index>>					\
//
